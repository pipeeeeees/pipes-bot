...
def get_gas(fullname_or_abbr):
        if len(fullname_or_abbr) == 2:
            mylist = ws.big_chunk_parser(ws.scrape('https://gasprices.aaa.com/?state='+fullname_or_abbr),
            ...
            mylist = ws.big_chunk_parser(ws.scrape('https://gasprices.aaa.com/?state='+abbr),
                                            'Current Avg.').replace('</td>','').split('<td>')
            return mylist[1][0:6],mylist[2][0:6],mylist[3][0:6],mylist[4][0:6]
